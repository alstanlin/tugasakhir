...
DATA_DIRS = [
    os.path.join(PROJECT_DIR, "Data Wearable EKG-Nano"),
    os.path.join(PROJECT_DIR, "Data Wearable EKG-Konv"),
]
LABEL_CSV = os.path.join(PROJECT_DIR, "labels_ujicoba.csv")

# Filter: hanya file ini yang akan dilabeli
TARGET_FILES = ["CL2810001", "CL2810002", "AS2902001", "GF1904001", "GF1904002", "JV2104001", "JV2104002"]
...
def denoise(signal_data):
    coeffs = pywt.wavedec(signal_data, wavelet='db4', level=5)
...
def load_all_windows():
    """Load file CSV tertentu dan potong jadi window 10 detik."""
    all_windows = []
    ...
    for data_dir in DATA_DIRS:
        ...
        for csv_path in csv_files:
            ...
            # Filter: hanya proses file yang ada di TARGET_FILES
            if not any(target in filename for target in TARGET_FILES):
                continue
...
class LabelingTool:
    ...
    def run(self):
        ...
        print("\n" + "="*60)
        print("  TOOL LABELING EKG INTERAKTIF")
        print("="*60)
